...
- **Per-page backdrop config via body data attributes:**
  ...
  - Current page settings: home (`/`, the former workshop file) `3`, about `12`, consulting `1`, links `0` + `ship="off"`. None set `data-aurora-mode`, so all default to asteroids. The `/workshop/` redirect stub has no backdrop.
